...
var ExplodeSimulation = {
	...
	switchExplode: function(explode) {
		...
		switch (explode.type) {
			case AMMO_9MM : explode.simulate = this.explode9mmSimulate; break;
			case AMMO_40MM : explode.simulate = this.explode40mmSimulate; break;
			case AMMO_ROCKET : explode.simulate = this.explodeRocketSimulate; break;
			case AMMO_TESLA : explode.simulate = this.explodeTeslaSimulate; break;
			case AMMO_SHELL : explode.simulate = this.explodeShellSimulate; break;
		}
	}	
...
var ExplodeRender = {
	...
	explodeRocketRender: function(ctx) {
		...
		drawElipse(ctx,20,20,this.range2 * 0.5,this.color2);
		drawElipse(ctx,-20,-20,this.range3 * 0.5,this.color3);
	},
	...
	switchExplode: function(explode) {
		...
		switch (explode.type) {
			case AMMO_9MM : explode.render = this.explode9mmRender; break;
			case AMMO_40MM : explode.render = this.explode40mmRender; break;
			case AMMO_ROCKET : explode.render = this.explodeRocketRender; break;
			case AMMO_TESLA : explode.render = this.explodeTeslaRender; break;
			case AMMO_SHELL : explode.render = this.explodeShellRender; break;
		}
	}			
...
var FireSimulation = {
	...
	switchFire: function(fire) {
		...
		switch (fire.type) {
			case AMMO_9MM : fire.simulate = this.fire9mmSimulate; break;
			case AMMO_40MM : fire.simulate = this.fire40mmSimulate; break;
			case AMMO_ROCKET : fire.simulate = this.fireRocketSimulate; break;
			case AMMO_TESLA : fire.simulate = this.fireTeslaSimulate; break;
			case AMMO_SHELL : fire.simulate = this.fireShellSimulate; break;
		}
	}	
...
var FireRender = {
	...
	switchFire: function(fire) {
		...
		switch (fire.type) {
			case AMMO_9MM : fire.render = this.fire9mmRender; break;
			case AMMO_40MM : fire.render = this.fire40mmRender; break;
			case AMMO_ROCKET : fire.render = this.fireRocketRender; break;
			case AMMO_TESLA : fire.render = this.fireTeslaRender; break;
			case AMMO_SHELL : fire.render = this.fireShellRender; break;
		}
	}			
