...
alert = function(input) {
	var a = document.getElementById("console").innerHTML;
	document.getElementById("console").innerHTML = input + "<br/>" + a;
}
...
$(document).ready(function() {
	...
	setInterval(function() { blaster.refresh(); }, 10);	// 100/sekunde
	setInterval(function() { blaster.draw(); }, 50);	// 20 fps
	...
	$("#chatInput").focusout(function() {window.okienko.zamknijChat();});
