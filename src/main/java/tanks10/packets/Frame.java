...
/**
 * Informacja o aktualnej klatce, jest wysyłana przed każdym updatem.
 * Wszystkie kolejne informacje są w odniesieniu do tej klatki
 * @author Macvek
 *
 */
public class Frame extends PacketWriteOnly{

	// f = numer klatki
	public Frame(long f) {fields.put("f", new Long(f)); }
	@Override public String getPacketName() { return "Frame"; }
