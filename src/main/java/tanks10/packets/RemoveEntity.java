...
/**
 * Wysyłany do klienta w momencie usunięcia jakiegoś entity
 * @author Macvek
 */
public class RemoveEntity extends PacketWriteOnly{
	@Override public String getPacketName() { return "RemoveEntity"; }
	public RemoveEntity(){}
	public RemoveEntity(Entity self) {
		fields.put("id", new Integer(self.getId()));
	}
}
