...
public class TanksWorld implements Runnable{
	...
	public static TanksWorld getWorld() {return world;}
	public TanksWorld() { 
	...
	public static Spectator newSpectator() {return world.spawnSpectator(newWorldId());}
	
	// Tworzy nowego entity administratora 
	public static God newGod() {return world.spawnGod(newWorldId());}
	
	// Tworzy nowego entity dla nowego połączenia
	public static Newbie newNewbie() {return world.spawnNewbie();}
	
	// Tworzy nowego entity dla SOLDATAA!!!!!!
	public static Soldier newSoldier(String model) {return world.spawnSoldier(newWorldId(),model);}
	...
	private void updateNames() {
		...
		synchronized(nameSet) {
			nameSet.clear();
			for(Soldier s : soldiers) { nameSet.add(s.getName()); }
			for(Spectator s : spectators) { nameSet.add(s.getName()); }
		}
	}
	...
	@Override public void run() { worldLogic(); }
	...
	private HashSet<Soldier> soldiers = new HashSet<Soldier>();	// oba są synchronizowane po entities
	private HashSet<Spectator> spectators = new HashSet<Spectator>();
	...
	public static void say(String msg) { world.broadcast(new Say(msg)); }
